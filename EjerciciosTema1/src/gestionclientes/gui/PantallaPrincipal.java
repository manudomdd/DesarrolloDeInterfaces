...
public class PantallaPrincipal extends javax.swing.JFrame {
    ...
    public PantallaPrincipal() {
        initComponents();
        table = new DefaultTableModel(null, tableIdentifiers);
    ...
    public void addCustomer(Cliente c) {
        ...
        String fechaForm = sdf.format(c.getFechaAlta()); 
       
        String[] cliente = {c.getNombre(), c.getApellidos(), fechaForm, c.getProvincia()};
        
        table.addRow(cliente);
    }
